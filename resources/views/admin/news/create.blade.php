      ...
      <form method="post" action="{{route('news.store')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> News create</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('url') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        <input type="url" class="form-control form_control" name="url" value="{{old('url')}}">
                        @if ($errors->has('url'))
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row mb-3 {{ $errors->has('link') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        <input type="url" class="form-control form_control" name="link" value="{{old('link')}}">
                        @if ($errors->has('link'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select class="form-control form_control" name="type">
                            <option value="">Choose news type</option>
                                ...
                                <option value="101">industry</option>
