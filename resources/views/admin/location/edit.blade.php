            ...
            <form method="post" action="{{route('location.update',$location->id)}}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Location Update</h4>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control form_control" name="name" value="{{old('name',$location->name ?: '')}}" placeholder="Country name here">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('color') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input class="" name="color" type="color"  value="{{old('color',$location->color ?: '')}}" placeholder="#fff">
                                @if ($errors->has('color'))
                                    <span class="invalid-feedback" role="alert">
