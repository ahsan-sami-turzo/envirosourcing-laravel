    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All Location Information</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{ route('location.create') }}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add Location</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      @foreach($locations as $data)
                        <tr>
                            <td>{{ $data->name ?: '' }}</td>
                            <td><div style="width: 25px; height: 15px; background:{{ $data->color ?: '' }}; "></div> </td>
                            <td>
...
{{--                                    <a class="dropdown-item" href='#'>Change Permission</a>--}}
                                    <a class="dropdown-item" href="{{ route('location.edit',$data->id) }}">Edit</a>
