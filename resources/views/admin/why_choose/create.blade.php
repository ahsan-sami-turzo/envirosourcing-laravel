...
<div class="row">
    <div class="col-12">
      <form method="post" action="{{route('why-choose.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Why Choose create</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('title') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control form_control" name="title" value="{{old('title')}}" placeholder="Why choose name here">
                    @if ($errors->has('title'))
