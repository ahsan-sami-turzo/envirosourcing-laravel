      ...
      <form method="post" action="{{route('company.store')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Company create</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('company_name') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="company_name" value="{{old('company_name')}}">
              ...
              <div class="form-group row mb-3">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="company_title_one" value="{{old('company_title_one')}}">
                  </div>
              </div>
              <div class="form-group row mb-3 {{ $errors->has('company_description_one') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                      <textarea class="summernote" name="company_description_one">{{ old('company_description_one') }}</textarea>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form_control" name="company_title_two" value="{{old('company_title_two')}}">
                    </div>
                </div>
                <div class="form-group row mb-3 {{ $errors->has('company_description_two') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        <textarea class="summernote" name="company_description_two">{{ old('company_description_two') }}</textarea>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form_control" name="company_title_three" value="{{old('company_title_three')}}">
                    </div>
                </div>
                <div class="form-group row mb-3 {{ $errors->has('company_description_three') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        <textarea class="summernote" name="company_description_three">{{ old('company_description_three') }}</textarea>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form_control" name="company_title_four" value="{{old('company_title_four')}}">
                    </div>
                </div>
                <div class="form-group row mb-3 {{ $errors->has('company_description_four') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        <textarea class="summernote" name="company_description_four">{{ old('company_description_four') }}</textarea>
