    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All Management Information</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{ route('management.create') }}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add Management</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                      @foreach($managements as $data)
                        <tr>
                            ...
                            <td><img style="height: 30px" src='{{  asset("uploads/management/$data->management_image")}}' alt=""></td>
                            <td>
...
{{--                                    <a class="dropdown-item" href='#'>Change Permission</a>--}}
                                    <a class="dropdown-item" href="{{ route('management.edit',$data->id) }}">Edit</a>
