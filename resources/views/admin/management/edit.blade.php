            ...
            <form method="post" action="{{route('management.update',$management->id)}}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Management Update
                                </h4>
                            </div>
                            <div class="col-md-4 text-right">
                                <a href="{{route('management.index')}}"
                                   class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i
                                        class="fas fa-th label-icon"></i>All Management list</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('designation') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label">Designation<span
                                    class="req_star">*</span>:</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control form_control" name="designation"
                                       value="{{old('designation',$management->name ?: '')}}">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('management_image') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label">Management Image (1000 X 500)<span
                                    class="req_star">*</span>:</label>
                            <div class="col-sm-5">
                        ...
                        <span class="input-group-btn">
                            ...
                            <strong>{{ $errors->first('management_image') }}</strong>
                                ...
                                @endif
                                <img id="img-upload"
                                     src='{{ isset($management->management_image ) ? asset("uploads/management/$management->management_image") : '' }}'/>
                            </div>
                        </div>
                    </div>
