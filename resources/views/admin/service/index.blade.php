            ...
            <div class="card-header card_header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{ route('service.create') }}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add Service</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                      @foreach($services as $data)
                        <tr>
                            ...
                            <td><img style="height: 30px" src='{{  asset("uploads/service/$data->services_image")}}' alt=""></td>
                            <td>
