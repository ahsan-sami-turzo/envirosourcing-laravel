...
<!--    <section>
      ...
      @if(count($company->companyCategories) > 0)
          <section id="about-page-products" class="pb-5">
              <div class="container-fluid">
                  @foreach( $company->companyCategories as $data )
                          <div class="row-product-img pb-5">
                              ...
                              @if(count($data->categoryProducts) > 0)
                                  <div class="row">
                                      @foreach( $data->categoryProducts as $product )
                                          <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                              <div class="category-product-card text-center" style=' background: url("{{ asset("uploads/product/$product->product_image") }}") no-repeat center center /cover;'>
